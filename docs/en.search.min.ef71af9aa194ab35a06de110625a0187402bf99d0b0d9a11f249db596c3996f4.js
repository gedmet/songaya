...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/songaya/flexsearch.min.js');loadScript('/songaya/en.search-data.min.cc2d8b4e9327fb486595786348a0850ec90958db794ccb85790510172f39c476.js',function(){input.required=false;search();});}
